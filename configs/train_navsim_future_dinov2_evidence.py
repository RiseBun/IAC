...
cfg = dict(base)
cfg["experiment_name"] = "iac_navsim_future_dinov2_evidence"
cfg["work_dir"] = str(project_root / "work_dirs" / "iac_navsim_future_dinov2_evidence")
...
cfg["dinov2"].update(
    ...
    use_future_consistency_evidence=True,
)
