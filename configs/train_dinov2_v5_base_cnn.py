"""v5 ablation: original CNN backbone, no D1-D4 sampler, no explicit distance."""
...
cfg["experiment_name"] = "nuplan_iac_v5_base_cnn"
cfg["work_dir"] = str(Path(__file__).resolve().parent.parent / "work_dirs" / "iac_v5_base_cnn")
