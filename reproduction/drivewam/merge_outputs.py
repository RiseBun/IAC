#!/usr/bin/env python3
"""Merge reused and newly generated DriveWAM rows for benchmark."""
...
def main() -> None:
    ...
    base = {row["source_key"]: row for row in read_lines(args.benchmark)}
    ...
    audit = {
        "protocol": "iac-benchmark-drivewam-generated",
        "rows": len(merged),
