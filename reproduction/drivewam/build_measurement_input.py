#!/usr/bin/env python3
"""Join WAM generated frames with private geometry for Level-1 probe."""
...
def main():
    ...
    base={r['source_key']:r for r in lines(a.benchmark)}; gen={r['source_key']:r for r in lines(a.generated)}; out=[]
    for r in sorted(base.values(), key=lambda x:int(str(x['benchmark_id']).rsplit('-',1)[-1])):
        ...
        # K is supplied in the source camera coordinate system.  The
