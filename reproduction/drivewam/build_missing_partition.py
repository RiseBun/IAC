#!/usr/bin/env python3
"""Create a balanced input partition for rows without paired branches."""
...
def main() -> None:
    ...
    ap.add_argument("--benchmark-inputs", type=Path, required=True)
    ...
    for local_global, row in enumerate(missing):
        ...
        source = args.benchmark_inputs / f"sample_{int(row['sample_index']):06d}.pkl"
        ...
        mapping.append({
            ...
            "benchmark_index": row["sample_index"],
            "shard": shard,
