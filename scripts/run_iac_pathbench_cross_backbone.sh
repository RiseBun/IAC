...
OUT_ROOT="${OUT_ROOT:-work_dirs/iac_pathbench_cross_backbone_2026_07_18}"
BENCH_MAX_GROUPS="${BENCH_MAX_GROUPS:-200}"
EVAL_BATCH_SIZE="${EVAL_BATCH_SIZE:-8}"
NUM_WORKERS="${NUM_WORKERS:-2}"
RUN_CNN="${RUN_CNN:-1}"
RUN_DINOV2="${RUN_DINOV2:-0}"
...
echo "[IAC] cross-backbone run complete: ${OUT_ROOT}"
