...
CONFIG="${CONFIG:-configs/train_dinov2_v5_nuplan.py}"
WORK_DIR="${WORK_DIR:-work_dirs/iac_dinov2_v5_nuplan_quick}"
TRAIN_INDEX="${TRAIN_INDEX:-indices/consistency_train.jsonl}"
VAL_INDEX="${VAL_INDEX:-indices/consistency_val.jsonl}"
