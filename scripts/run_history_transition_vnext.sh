...
CONFIG="${CONFIG:-configs/train_navsim_future_dinov2_history_transition_vnext.py}"
WORK_DIR="${WORK_DIR:-work_dirs/iac_navsim_future_dinov2_history_transition_vnext}"
RESUME_FROM="${RESUME_FROM:-work_dirs/iac_navsim_future_dinov2_path_evidence_fused_vnext/checkpoints/best.pth}"
