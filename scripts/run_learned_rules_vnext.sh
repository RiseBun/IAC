...
CONFIG="${CONFIG:-configs/train_navsim_future_dinov2_learned_rules_vnext.py}"
WORK_DIR="${WORK_DIR:-work_dirs/iac_navsim_future_dinov2_learned_rules_vnext}"
RESUME_FROM="${RESUME_FROM:-work_dirs/iac_navsim_future_dinov2_history_transition_vnext/checkpoints/latest.pth}"
