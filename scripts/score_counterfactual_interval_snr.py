#!/usr/bin/env python3
"""Run the experimental interval-aligned/SNR-gated counterfactual score."""
...
from iac_new.flow_structure_scoring import score_counterfactual_structure_pairs_interval_aligned
...
def main() -> None:
    ...
    parser.add_argument("--minimum-snr-intervals", type=int, default=2)
    parser.add_argument("--flow-delta-deadband", type=float, default=0.005)
    ...
    report = score_counterfactual_structure_pairs_interval_aligned(
        ...
        minimum_snr_intervals=args.minimum_snr_intervals,
        flow_delta_deadband=args.flow_delta_deadband,
