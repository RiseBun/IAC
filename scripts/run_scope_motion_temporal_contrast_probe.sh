...
CONFIG="${CONFIG:-configs/train_navsim_future_dinov2_scope_motion_temporal_contrast_probe.py}"
BASE_CKPT="${BASE_CKPT:-work_dirs/iac_navsim_future_dinov2_supported_set_listwise_vnext/checkpoints/latest.pth}"
WORK_DIR="${WORK_DIR:-work_dirs/iac_navsim_future_dinov2_scope_motion_temporal_contrast_probe}"
EPOCHS="${EPOCHS:-7}"
