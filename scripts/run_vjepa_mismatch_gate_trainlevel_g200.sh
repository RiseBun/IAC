...
GROUPED_PROBE="${GROUPED_PROBE:-work_dirs/iac_navsim_future_dinov2_supported_set_listwise_recovered_set_vnext/recovered_path_set_probe_grouped_k8/recovered_path_set_probe.pt}"
