        ...
        if bool(temporal_cfg.get("enabled", False)):
            try:
                ...
                if bool(ego_cfg.get("enabled", False)):
                    ...
                    ego_frame_boundary_fusion = {"protocol": "ego-frame-boundary-fusion", "image_boundaries": image_boundaries, "raw_ego_boundaries": ego_boundaries, "ego_boundaries": fused, "diagnostics": fusion_diag}
            except (ValueError, np.linalg.LinAlgError) as error:
