...
CONFIG="${CONFIG:-configs/train_navsim_future_dinov2_path_evidence_vnext.py}"
WORK_DIR="${WORK_DIR:-work_dirs/iac_navsim_future_dinov2_path_evidence_vnext}"
...
echo "[IAC] vNext run complete: ${WORK_DIR}"
