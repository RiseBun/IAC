...
Optional AS/RCS/GS and future-to-action cells (with legacy CFAC/CCFC/FAU aliases)
...
from iac_new.scorecard import build_model_scorecard, validate_submission
